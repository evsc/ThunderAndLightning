...
Breakout board
-----
[AS3935 Lightning Sensor Dev Board](http://wiki.tautic.com/Category:AS3935_Lightning_Sensor_Dev_Board), bought at [Tindie](https://www.tindie.com/products/TAUTIC/as3935-lightning-sensor-board/) which comes with an onboard antenna. All you need to get it working is to connect it up to an microcontroller. The Tindie board is setup for SPI communication, but can also enable I2C by soldering some jumpers on the bottomside of the board. 
...
I added some minor functionality to this library (see library directory in this repository):
...
Output
------
Successful lightning strike detection results in an energy value and a distance value. The distance corresponds to the distance of the storm head instead of the distance to the last lightning strike. The system stores all recent lighting strikes and uses them to calculate  the storm head. 
